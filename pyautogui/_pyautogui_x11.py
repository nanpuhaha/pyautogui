...
def _keyUp(key):
    ...
    keycode = key if type(key) == int else keyboardMapping[key]
...
keyboardMapping = dict([(key, None) for key in pyautogui.KEY_NAMES]) | {
    'backspace': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('BackSpace')
    ),
    ...
    'capslock': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Caps_Lock')
    ),
    ...
    'pagedown': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Page_Down')
    ),
    ...
    'printscreen': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Print')
    ),
    ...
    'winright': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Super_R')
    ),
    ...
    'multiply': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('KP_Multiply')
    ),
    ...
    'subtract': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('KP_Subtract')
    ),
    'decimal': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('KP_Decimal')
    ),
    'divide': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('KP_Divide')
    ),
    ...
    'numlock': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Num_Lock')
    ),
    'scrolllock': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Scroll_Lock')
    ),
    'shiftleft': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Shift_L')
    ),
    'shiftright': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Shift_R')
    ),
    'ctrlleft': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Control_L')
    ),
    'ctrlright': _display.keysym_to_keycode(
        Xlib.XK.string_to_keysym('Control_R')
    ),
